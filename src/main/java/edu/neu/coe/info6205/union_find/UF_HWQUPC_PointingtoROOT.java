 ...
 */
public class UF_HWQUPC_PointingtoROOT implements UF {
    /**
     ...
     */
    public UF_HWQUPC_PointingtoROOT(int n, boolean pathCompression) {
        count = n;
        parent = new int[n];
        height = new int[n];
        for (int i = 0; i < n; i++) {
     ...
     * @throws IllegalArgumentException if {@code n < 0}
     */
    public UF_HWQUPC_PointingtoROOT(int n) {
        this(n, true);
    }
...
//    		int noofSites = Integer.parseInt(args[0]);
    		UF_HWQUPC_PointingtoROOT data = new UF_HWQUPC_PointingtoROOT(10);
